...
export const universe_new: (a: number, b: number, c: number) => number;
export const universe_render: (a: number) => [number, number];
export const universe_resize: (a: number, b: number, c: number) => void;
export const universe_set_cells_from_bytes: (a: number, b: number, c: number) => void;
