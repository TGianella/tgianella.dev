...
<Callout>
In a Webpack-based setup, **most of the transpilation work happens inside loaders**. Webpack itself is responsible for building the dependency graph, but every file then goes through one or more loaders to be transformed before being bundled.
</Callout>
...
<Image src={finalProcess} alt="Final hybrid SWC + Babel build process diagram" />
